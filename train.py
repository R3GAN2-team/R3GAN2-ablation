...
def main(**kwargs):
    ...
    if opts.preset == 'CIFAR10':
        ...
        NoiseDimension = 64
        aug_config = dict(always_xflip=True, yflip=1, rotate_int=1, translate_int=1, scale=1, rotate_frac=1, aniso=1, translate_frac=1, brightness=0.5, contrast=0.5, lumaflip=0.5, chromaflip=0.5, saturation=0.5, cutout=1)
